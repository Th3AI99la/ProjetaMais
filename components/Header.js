...
export default function Header({ title, onLeftPress, leftIconName, backgroundColor }) {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top + 10, paddingBottom: 10, backgroundColor }]}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('Configurações')} style={styles.iconButton}>
